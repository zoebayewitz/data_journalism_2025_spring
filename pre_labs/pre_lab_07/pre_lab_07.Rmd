...
```{r echo=FALSE}
census_api_key("54b19cb9a415fe4d40cfc9690d1620a1f07790fc", install=TRUE)
```
...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer: Nevada**
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer: Howard County**
...
Is the difference between Calvert and Montgomery significant? **Answer: No**

Is the difference between Howard and everyone else significant? **Answer: Yes**
...
**Answer: 21202 is the only one that has less than $50,000 estimated median household income.**
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Answer: What is the demographic makeup of these areas, who did they tend to vote for, has their voting participation increased/decreased  in the past few years**
