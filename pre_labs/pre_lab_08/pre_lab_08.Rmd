...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer: 24 rows, 18 columns**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I don't see anything except a blank box.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see a bar chart with the count on the y axis and the county name on the x axis.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: This code is the same, except the count is in ascending order to make visualization easier.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: The chart now goes horizontally so the county names are easier to read.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: The background color changed, which made the bars pop more.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer: There's new colors and instead of a grid in the background, there's just lines**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: The y axis is named differently, the x axis says "county" instead of count, and the title is bolded.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: The code calculated the total distributions of every date.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see a basic geometric line chart.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: the specific dates were included.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: the dates are spaced out so they're much easier to read.**
